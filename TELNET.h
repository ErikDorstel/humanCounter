...
void doCommand(String command) {
  ...
  if (buffer.indexOf("help")>=0) { telnetClient.print("version\r\nhelp\r\nexit\r\nfree\r\nformat\r\nformat test\r\nreboot\r\nruntime\r\nclear\r\ngreenOn\r\nalarmOn\r\ndebug [on/off]\r\n"); } else
  ...
  if (buffer.indexOf("version")>=0) { telnetClient.print("Version: "); telnetClient.print(version); telnetClient.print("\r\n"); } else
